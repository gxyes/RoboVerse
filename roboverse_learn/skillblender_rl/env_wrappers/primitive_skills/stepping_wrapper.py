...
from metasim.utils.humanoid_robot_util import contact_forces_tensor, dof_pos_tensor, dof_vel_tensor, sample_fp
...
class SteppingWrapper(HumanoidBaseWrapper):
    ...
    def _parse_ref_pos(self, envstate: DictEnvState):
